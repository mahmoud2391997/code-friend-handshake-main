      ...
      return (next) => (action) => {
        ...
        measureUtils.measureTime(() => {
          ...
          if (result.wasMutated) {
            throw new Error(true ? formatProdErrorMessage2(19) : `A state mutation was detected between dispatches, in the path '${result.path || ""}'.  This may cause incorrect behavior. (https://redux.js.org/style-guide/style-guide#do-not-mutate-state)`);
          }
        });
        ...
        measureUtils.measureTime(() => {
          ...
          tracker = track(state);
          if (result.wasMutated) {
            throw new Error(true ? formatProdErrorMessage2(20) : `A state mutation was detected inside a dispatch, in the path: ${result.path || ""}. Take a look at the reducer(s) handling the action ${stringify2(action)}. (https://redux.js.org/style-guide/style-guide#do-not-mutate-state)`);
          }
        });
...
//# sourceMappingURL=chunk-UFEAWBAE.js.map
