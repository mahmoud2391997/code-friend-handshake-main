...
// Common pattern for all entity APIs - constrained to object types
type BaseEntityRequest<T extends Record<string, any>> = Omit<T, "id" | "_id" | "createdAt" | "updatedAt" | "created_at" | "updated_at">;
type BaseEntityUpdateRequest<T extends Record<string, any>> = Partial<BaseEntityRequest<T>>;
