...
export const PERMISSIONS: Record<Role, Permission[]> = {
    ...
    [Role.FinancialManager]: ['purchases:create', 'purchases:read', 'purchases:update', 'sales:read', 'employees:read', 'licenses:read', 'inventory:read', 'supplies:read', 'payroll:manage', 'payroll:read', 'reports:read:full', 'advances:manage', 'general_requests:manage'],
