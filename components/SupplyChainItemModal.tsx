          ...
          <div className="modal-body" style={{ padding: '1rem 2rem' }}>
            <div className="form-row" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              <div className="form-group">
                ...
                <input id="productName" name="productName" value={formData.productName} onChange={handleChange} className="form-input-enhanced" placeholder="أدخل اسم المادة يدويًا" />
