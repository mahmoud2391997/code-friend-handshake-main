...
import { Branch, Customer, Project, User } from '../types';
...
const CustomerModal: React.FC<CustomerModalProps> = ({ customer, onClose, onSave, branches, projects, existingCustomers = [], currentUser }) => {
                ...
                <div className="modal-body" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => handleChange('projectId', e.target.value ? parseInt(e.target.value, 10) : undefined)}
